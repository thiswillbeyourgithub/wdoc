...
* This will:
    ...
    7. Then each relevant doc is sent to the strong LLM (by default, openrouter/google/gemini-3.1-pro) to extract relevant info and give one answer per relevant document.
...
* This will:
    ...
    2. pass each chunk into the strong LLM (by default openrouter/google/gemini-3.1-pro) for a very low level (=with all details) summary. The format is markdown bullet points for each idea and with logical indentation.
