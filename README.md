...
7. If you want to make sure your data remains private here's an example: `python DoctoolsLLM.py --private --llms_api_bases='{"model": "localhost:8000", "query_eval_model": "localhost:8000"}' --modelname="openai/my_modelname" --query_eval_modelname="openai/my_evalmodel" --embed_model="BAAI/bge-m3" --task=my_task`
