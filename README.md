...
7. If you want to make sure your data remains private here's an example: `python DoctoolsLLM.py --private --llms_api_bases={model:"localhost:8000",eval_model:"localhost:8000"} --model="openai/my_modelname" --eval_model="openai/my_evalmodel" --embed_model="BAAI/bge-m3" --task=my_task`
