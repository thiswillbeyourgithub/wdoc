...
_complete-wdoc()
{
  ...
  opts=""
  GLOBAL_OPTIONS="--llms-api-bases --summary-language --embed-kwargs --embed-instruct --query-relevancy --load-functions --pdf-parsers --file-loader-n-jobs --embed-model --doccheck-max-token --exclude --notification-callback --audio-unsilence --online-media-resourcetype-regex --deepgram-kwargs --youtube-language --summary-n-recursion --private --load-embeds-from --anki-template --doccheck-min-lang-prob --debug --import-mode --out-file --online-media-url-regex --whisper-lang --youtube-translation --filter-metadata --json-dict-exclude-keys --task --query-eval-modelname --save-embeds-as --verbose --dollar-limit --anki-deck --DIY-rolling-window-embedding --anki-notetype --audio-backend --whisper-prompt --query-retrievers --silent --anki-profile --query-eval-check-number --file-loader-parallel-backend --youtube-audio-backend --top-k --json-dict-template --anki-tag-render-filter --loading-failure --filter-content --modelname --filetype --query --llm-verbosity --disable-md-printing --source-tag --anki-tag-filter --disable-llm-cache --path --include --version --doccheck-min-token"
