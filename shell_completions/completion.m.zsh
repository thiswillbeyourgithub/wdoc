...
_complete-__main__py()
{
  ...
  opts=""
  GLOBAL_OPTIONS="--DIY-rolling-window-embedding --private --debug --load-embeds-from --audio-unsilence --query-retrievers --load-functions --filetype --online-media-resourcetype-regex --anki-notetype --query-relevancy --file-loader-n-jobs --top-k --disable-md-printing --audio-backend --whisper-prompt --modelname --import-mode --save-embeds-as --llm-verbosity --out-file --summary-n-recursion --query --summary-language --source-tag --file-loader-parallel-backend --doccheck-min-token --silent --whisper-lang --online-media-url-regex --deepgram-kwargs --embed-instruct --loading-failure --filter-content --llms-api-bases --task --doccheck-min-lang-prob --embed-kwargs --doccheck-max-token --include --embed-model --anki-tag-filter --filter-metadata --exclude --anki-profile --dollar-limit --notification-callback --disable-llm-cache --anki-template --youtube-audio-backend --doccheck-max-lines --youtube-translation --path --query-eval-modelname --query-eval-check-number --youtube-language --version --anki-deck --verbose"
