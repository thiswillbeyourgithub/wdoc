...
_complete-__main__py()
{
  ...
  opts=""
  GLOBAL_OPTIONS="--llms-api-bases --out-file --query-eval-modelname --summary-language --onlinemedia-url-regex --modelname --doccheck-min-lang-prob --youtube-translation --import-mode --notification-callback --task --audio-unsilence --embed-instruct --file-loader-parallel-backend --disable-md-printing --onlinemedia-resourcetype-regex --llm-verbosity --audio-backend --file-loader-n-jobs --private --whisper-prompt --summary-n-recursion --query-relevancy --anki-notetype --disable-llm-cache --embed-kwargs --path --whisper-lang --youtube-audio-backend --debug --doccheck-min-token --query --anki-deck --load-functions --top-k --save-embeds-as --doccheck-max-token --query-retrievers --anki-tag-filter --youtube-language --include --dollar-limit --filter-content --filetype --anki-profile --source-tag --deepgram-kwargs --query-condense-question --doccheck-max-lines --load-embeds-from --DIY-rolling-window-embedding --filter-metadata --embed-model --exclude --memoryless --loading-failure --query-eval-check-number --anki-template"
