...
_complete-WDoc()
{
  ...
  opts=""
  GLOBAL_OPTIONS="--source-tag --exclude --online-media-url-regex --whisper-lang --file-loader-n-jobs --doccheck-max-token --filter-content --query-eval-check-number --json-dict-exclude-keys --dollar-limit --disable-llm-cache --include --online-media-resourcetype-regex --DIY-rolling-window-embedding --verbose --youtube-translation --load-functions --query-retrievers --youtube-audio-backend --anki-tag-filter --top-k --notification-callback --query --filetype --private --audio-backend --anki-notetype --version --anki-tag-render-filter --deepgram-kwargs --modelname --debug --embed-instruct --path --embed-kwargs --load-embeds-from --whisper-prompt --doccheck-min-token --task --silent --json-dict-template --summary-language --loading-failure --file-loader-parallel-backend --youtube-language --query-eval-modelname --disable-md-printing --llm-verbosity --import-mode --anki-template --embed-model --summary-n-recursion --audio-unsilence --anki-deck --out-file --filter-metadata --llms-api-bases --doccheck-min-lang-prob --save-embeds-as --query-relevancy --anki-profile"
