# bash completion support for wd
# DO NOT EDIT.
...
_complete-wd()
{
  ...
  opts=""
  GLOBAL_OPTIONS="--load-embeds-from --loading-failure --source-tag --onlinemedia-resourcetype-regex --doccheck-min-token --onlinemedia-url-regex --save-embeds-as --anki-tag-filter --query-eval-check-number --whisper-lang --summary-n-recursion --deepgram-kwargs --filter-metadata --top-k --audio-unsilence --dollar-limit --llm-verbosity --DIY-rolling-window-embedding --youtube-translation --youtube-audio-backend --embed-model --include --file-loader-n-jobs --disable-md-printing --modelname --exclude --youtube-language --anki-template --doccheck-min-lang-prob --audio-backend --notification-callback --embed-instruct --file-loader-parallel-backend --path --anki-deck --filter-content --summary-language --doccheck-max-token --anki-notetype --query-retrievers --filetype --query-eval-modelname --embed-kwargs --query-relevancy --query --private --whisper-prompt --disable-llm-cache --out-file --import-mode --debug --anki-profile --llms-api-bases --doccheck-max-lines --load-functions --task"
