...
with open("README.md", "r") as readme:
    ...
    assert '<p align="center"><img src="https://github.com/thiswillbeyourgithub/wdoc/blob/main/images/icon.png?raw=true" width="512" style="background-color: transparent !important"></p>' in long_description, "Unexpected HTML for the icon"
