...
def set_help_md_as_docstring(obj: Union[Type, Callable]) -> Union[Type, Callable]:
    ...
    if not help_file.exists():
        red(f"Couldn't find help.md file as '{help_file}'. You can read it at this URL instead: https://github.com/thiswillbeyourgithub/wdoc/blob/main/wdoc/docs/help.md")
        ...
        if not helpcont:
            ...
            helpcont = "Help documentation is empty. Please refer to online documentation."
...
def set_parse_file_help_md_as_docstring(
    ...
    if not parsefilehelp_file.exists():
        red(f"Couldn't find parse_file_help.md file as '{parsefilehelp_file}'. You can read it at this URL instead: https://github.com/thiswillbeyourgithub/wdoc/blob/main/wdoc/docs/parse_file_help.md")
