...
WDOC_IMPORT_TYPE = "native"
WDOC_MOD_FAISS_SCORE_FN = False
WDOC_LLM_MAX_CONCURRENCY = 1
WDOC_SEMANTIC_BATCH_MAX_TOKEN_SIZE = 2000
WDOC_MAX_CHUNK_SIZE = 16_000
WDOC_INTERMEDIATE_ANSWER_MAX_TOKENS = 4000
...
WDOC_DISABLE_EMBEDDINGS_CACHE = False
